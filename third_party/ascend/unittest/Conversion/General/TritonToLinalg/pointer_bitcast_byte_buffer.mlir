...
// RUN: triton-opt '--triton-to-unstructure=compile-on-910-95=True compile-mode=simt_template' --split-input-file %s | FileCheck %s --check-prefix=SIMT
// RUN: triton-opt '--triton-to-unstructure=compile-on-910-95=True compile-mode=simt_template' '--triton-to-linalg=compile-on-910-95=True compile-mode=simt_template' --split-input-file %s | FileCheck %s --check-prefix=SIMT-LINALG
